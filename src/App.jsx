...
function App() {
  ...
  return (
    <div className="relative min-h-screen text-secondary">
      {/* Fixed background image layer, stays behind all content */}
      <div
        className="fixed inset-0 bg-decorative bg-cover bg-center z-0"
        aria-hidden="true"
      ></div>

      {/* Main content, appears on top of background */}
